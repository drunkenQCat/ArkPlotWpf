...
public static class CliOptions
{
    ...
    public static readonly bool UseMockVision = true;

    /// <summary>开启时使用百炼视觉模型生成真实图片描述。</summary>
    public static readonly bool EnableVision = true;

    /// <summary>开启时使用 EdgeTTS 生成章节音频。</summary>
    public static readonly bool EnableTts = false;

    /// <summary>开启时输出带图片描述的增强版 Markdown（含 2 行角色表）。关闭时输出简洁版。</summary>
    public static readonly bool EnablePicDesc = true;
}
