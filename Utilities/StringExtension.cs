...
{
    public static StringDict ToObject(this string input, string sep1 = ",", string sep2 = "=", bool tolower = true)
    {
    ...
    {
        return input.Replace("\r", "").Split(new string[] { sep }, StringSplitOptions.None);
    }
